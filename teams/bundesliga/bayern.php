...
<body>
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://v3.football.api-sports.io/players/squads?team=157',
	...
	<div class="container">
		...
		<div class="main">
			<div class="nav">
				<div class="logo">
					<a href="arsenal.html"><img src="../../img/teams_logo/bay.png" alt="#" id="img" class="nav__logo"></a>
				</div>
				<div class="listing">
					<ul class="list">
			...
			<section id=match>
				<div class="shedule" id="wg-api-football-fixtures" data-host="v3.football.api-sports.io" data-refresh="60" data-date="" data-league="" data-team="157" data-season="2021" data-last="" data-next="2" data-key="06e579cb3495c840201e0e7869b648b7" data-theme="" data-show-errors="false" class="api_football_loader">
				</div>
			...
			<section id="Stadion">
				<div class="stadium">
					...
					<div class="photo__stadium">
						<img alt="#" class="stadium__img" src="../../img/stadium/alianz.jpeg">
					</div>
					<div class="about__stadium">
						<h1 class="stadium-info__title">Информация о стадионе</h1>
						<div class="stadium-info__text">
							<p class="stadium__text">Название: <span>Alianz Arena</span></p>
							<p class="stadium__text">Местоположение: <span>Мюнхен</span></p>
							<p class="stadium__text">Построен: <span>2005</span></p>
							<p class="stadium__text">Категория УЕФА: <span>4</span></p>
							<p class="stadium__text">Стоимость: <span>£ 340 млн </span></p>
							<p class="stadium__text">Вместимость: <span>75 000</span></p>
			...
			<section id="Dost">
				...
				<div class="titles">
					<div class="apl">
						<div class="titles__photo"><img src="../../img/tour__logo/bundesliga.jpg" alt="#" width="200px" height="140px"></div>
						<div class="titles__win">
							<p class="titles__win-text"> Обладатели:</p>
							<p class="titles__number">31</p>
						</div>
						<div class="titles__name">Бундеслига</div>
					</div>
					<div class="titles__ka">
						<div class="titles__photo"><img src="../../img/tour__logo/kubokgermanii.jpg" alt="#" width="200px" height="120px"></div>
						<div class="titles__win">
							<p class="titles__win-text"> Обладатели:</p>
							<p class="titles__number">20</p>
						</div>
						<div class="titles__name">Кубок Германии</div>
					</div>
					<div class="titles__kl">
						...
						<div class="titles__win">
							...
							<div class="titles__sa">
								<div class="titles__photo"><img src="../../img/tour__logo/supercup germany.png" alt="#" width="150px" height="140px"></div>
								<div class="titles__win">
									<p class="titles__win-text"> Обладатели:</p>
