...
<body>
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://v3.football.api-sports.io/players/squads?team=529',
	...
	<div class="container">
		...
		<div class="main">
			...
			<section id=match>
				<div class="shedule" id="wg-api-football-fixtures" data-host="v3.football.api-sports.io" data-refresh="60" data-date="" data-league="" data-team="529" data-season="2021" data-last="" data-next="2" data-key="06e579cb3495c840201e0e7869b648b7" data-theme="" data-show-errors="false" class="api_football_loader">
				</div>
				...
				<div class="stadium">
					...
					<div class="about__stadium">
						...
						<div class="stadium-info__text">
							<p class="stadium__text">Название: <span>Estadio Camp Nou</span></p>
							<p class="stadium__text">Местоположение: <span>Барселона, Испания</span></p>
							<p class="stadium__text">Построен: <span>1957</span></p>
							<p class="stadium__text">Категория УЕФА: <span>4</span></p>
							<p class="stadium__text">Стоимость: <span>£ 288 млн </span></p>
							<p class="stadium__text">Вместимость: <span>99 354</span></p>
							<p class="stadium__text">Размеры поля: <span>106 * 70 м</span></p>
						</div>
					</div>
				</div>
			</section>
