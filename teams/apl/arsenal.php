...
<body>
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://v3.football.api-sports.io/players/squads?team=42',
	...
	<div class="container">
		...
		<div class="main">
			<div class="nav">
				<div class="logo">
					<a href="arsenal.html"><img src="../../img/teams_logo/ars.png" alt="#" id="img" class="nav__logo"></a>
				</div>
				<div class="listing">
					<ul class="list">
			...
			<section id=match>
				<div class="shedule" id="wg-api-football-fixtures" data-host="v3.football.api-sports.io" data-refresh="60" data-date="" data-league="" data-team="42" data-season="2021" data-last="" data-next="2" data-key="06e579cb3495c840201e0e7869b648b7" data-theme="" data-show-errors="false" class="api_football_loader">
				</div>
				...
				<div class="stadium">
					...
					<div class="about__stadium">
						...
						<div class="stadium-info__text">
							...
							<p class="stadium__text">Местоположение: <span>Холлоуэй, Ислингтон, Лондон</span></p>
							<p class="stadium__text">Построен: <span>2006</span></p>
							<p class="stadium__text">Категория УЕФА: <span>4</span></p>
							<p class="stadium__text">Стоимость: <span>£ 390 млн </span></p>
							<p class="stadium__text">Вместимость: <span>60 704</span></p>
