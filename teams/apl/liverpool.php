...
<body>
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://v3.football.api-sports.io/players/squads?team=40',
	...
	<div class="container">
		...
		<div class="main">
			<div class="nav">
				<div class="logo">
					<a href="arsenal.html"><img src="../../img/teams_logo/liver.png" alt="#" id="img" class="nav__logo"></a>
				</div>
				<div class="listing">
					<ul class="list">
			...
			<section id=match>
				<div class="shedule" id="wg-api-football-fixtures" data-host="v3.football.api-sports.io" data-refresh="60" data-date="" data-league="" data-team="40" data-season="2021" data-last="" data-next="2" data-key="06e579cb3495c840201e0e7869b648b7" data-theme="" data-show-errors="false" class="api_football_loader">
				</div>
				...
				<div class="stadium">
					...
					<div class="about__stadium">
						...
						<div class="stadium-info__text">
							<p class="stadium__text">Название: <span>Emirates Stadium</span></p>
							<p class="stadium__text">Местоположение: <span>Ливерпуль, Великобритания</span></p>
							<p class="stadium__text">Построен: <span>1884</span></p>
							<p class="stadium__text">Категория УЕФА: <span>4</span></p>
							<p class="stadium__text">Вместимость: <span>53 394</span></p>
							<p class="stadium__text">Размеры поля: <span>101 * 68 м</span></p>
						</div>
					</div>
				</div>
			</section>
