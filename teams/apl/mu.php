...
<body>
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://v3.football.api-sports.io/players/squads?team=33',
	...
	<div class="container">
		...
		<div class="main">
			<div class="nav">
				<div class="logo">
					<a href="mu.php"><img src="../../img/teams_logo/mu.png" alt="#" id="img" class="nav__logo mu__logo"></a>
				</div>
				<div class="listing">
					<ul class="list">
			...
			<section id=match>
				<div class="shedule" id="wg-api-football-fixtures" data-host="v3.football.api-sports.io" data-refresh="60" data-date="" data-league="" data-team="33" data-season="2021" data-last="" data-next="2" data-key="06e579cb3495c840201e0e7869b648b7" data-theme="" data-show-errors="false" class="api_football_loader">
				</div>
			...
			<section id="Stadion">
				<div class="stadium">
					...
					<div class="photo__stadium">
						<img alt="#" class="stadium__img" src="../../img/stadium/old traff.jpg">
					</div>
					<div class="about__stadium">
						<h1 class="stadium-info__title">Информация о стадионе</h1>
						<div class="stadium-info__text">
							<p class="stadium__text">Название: <span>Old Trafford</span></p>
							<p class="stadium__text">Местоположение: <span>Дорога им. сэра Мэтта Басби, Траффорд, Большой Манчестер, Англия</span></p>
							<p class="stadium__text">Построен: <span>1909</span></p>
							<p class="stadium__text">Категория УЕФА: <span>4</span></p>
							<p class="stadium__text">Стоимость: <span>£ 90 000 </span></p>
							<p class="stadium__text">Вместимость: <span>74 994</span></p>
			...
			<section id="Dost">
				...
				<div class="titles">
					<div class="apl">
						<div class="titles__photo"><img src="../../img/apl.jpg" alt="#" width="200px" height="140px"></div>
						<div class="titles__win">
							<p class="titles__win-text"> Обладатели:</p>
							<p class="titles__number">20</p>
						</div>
						<div class="titles__name">Английская премьер-лига</div>
					</div>
					<div class="titles__ka">
						<div class="titles__photo"><img src="../../img/fa.jpg" alt="#" width="200px" height="120px"></div>
						<div class="titles__win">
							<p class="titles__win-text"> Обладатели:</p>
							<p class="titles__number">12</p>
						</div>
						<div class="titles__name">Кубок Англии</div>
					</div>
					<div class="titles__kl">
						<div class="titles__photo"><img src="../../img/ca.jpg" alt="#" width="200px" height="140px"></div>
						<div class="titles__win">
							<p class="titles__win-text"> Обладатели:</p>
							<p class="titles__number">5</p>
						</div>
						<div class="titles__name">Кубок Английской футбольной лиги</div>
					</div>
					<div class="titles__sa">
						<div class="titles__photo"><img src="../../img/sc.png" alt="#" width="150px" height="140px"></div>
						<div class="titles__win">
							<p class="titles__win-text"> Обладатели:</p>
							<p class="titles__number">21</p>
						</div>
						<div class="titles__name">Суперкубок Англиич</div>
					</div>
					<div class="ligue-champions">
						<div class="titles__photo"><img src="../../img/lc.png" alt="#" width="150px" height="140px"></div>
						<div class="titles__win">
							<p class="titles__win-text"> Обладатели:</p>
							<p class="titles__number">3</p>
						</div>
