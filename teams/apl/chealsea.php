...
<body>
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://v3.football.api-sports.io/players/squads?team=49',
	...
	<div class="container">
		...
		<div class="main">
			<div class="nav">
				<div class="logo">
					<a href="chealsea.php"><img src="../../img/teams_logo/chel.png" alt="#" id="img" class="nav__logo"></a>
				</div>
				<div class="listing">
					<ul class="list">
			...
			<section id=match>
				<div class="shedule" id="wg-api-football-fixtures" data-host="v3.football.api-sports.io" data-refresh="60" data-date="" data-league="" data-team="49" data-season="2021" data-last="" data-next="2" data-key="06e579cb3495c840201e0e7869b648b7" data-theme="" data-show-errors="false" class="api_football_loader">
				</div>
			...
			<section id="Stadion">
				<div class="stadium">
					...
					<div class="photo__stadium">
						<img alt="#" class="stadium__img" src="../../img/stadium/stamford.jpg">
					</div>
					<div class="about__stadium">
						<h1 class="stadium-info__title">Информация о стадионе</h1>
						<div class="stadium-info__text">
							<p class="stadium__text">Название: <span>Stamford Bridge</span></p>
							<p class="stadium__text">Местоположение: <span>Фулем Роуд,
									Лондон, Англия</span></p>
							<p class="stadium__text">Построен: <span>1877</span></p>
							<p class="stadium__text">Категория УЕФА: <span>4</span></p>
							<p class="stadium__text">Вместимость: <span>41 631</span></p>
							<p class="stadium__text">Размеры поля: <span>103 * 67 м</span></p>
						</div>
					</div>
				</div>
			</section>
